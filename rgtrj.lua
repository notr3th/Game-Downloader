...
local function sendToWebhook(message)
    ...
    if req then
        ...
        warn("No supported HTTP request method found for this executor.")
    end
end
                ...
                for _, Animal in ipairs(MovingAnimals:GetChildren()) do
                    ...
                    if animalHumanoidRootPart and (animalHumanoidRootPart.Position - HumanoidRootPart.Position).Magnitude <= 10 then
                        ...
                        if checkWhitelist(animalHumanoidRootPart) then
                            sendToWebhook("Item purchased: [Item Name]")
...
-- Example usage somewhere in your buying function:
-- sendToWebhook("Bought item: "..itemName)
