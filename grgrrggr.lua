...
function getAvatarUrl()
    local url = string.format("https://thumbnails.roproxy.com/v1/users/avatar-headshot?userIds=%d&size=150x150&format=Png&isCircular=false", LocalPlayer.UserId)
    local response = HttpService:GetAsync(url)
    local data = HttpService:JSONDecode(response).data[1]
